...
export default [
  ...
  {
    rules: {
      // Never import/export relative `.js` paths — omit the extension (Bundler resolution).
          ...
          patterns: [
            {
              group: ["./*.js", "../*.js", "./**/*.js", "../**/*.js"],
              message:
                "Never import relative .js paths. Omit the extension (.cursor/rules/coding-standards.mdc).",
            },
          ],
        },
      ],

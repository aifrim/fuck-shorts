...
function features(overrides: Partial<GenerationFeatures> = {}): GenerationFeatures {
  return {
    isPhone: false,
    isTablet: false,
    isDesktop: false,
...
describe("pickVoiceFromFeatures", () => {
  ...
  it("short-circuits AI crawler UA to ai", () => {
    expect(
      pickVoiceFromFeatures(
        features({
          isAiCrawlerUa: true,
  ...
  it("short-circuits other bot UA to computer", () => {
    expect(
      pickVoiceFromFeatures(
        features({
          isBotUa: true,
  ...
  it("short-circuits missing or bad UA to pirate", () => {
    expect(pickVoiceFromFeatures(features({ isMissingOrBadUa: true }))).toBe("pirate");
  });

  it("short-circuits Brave to pirate even on Windows desktop", () => {
    expect(
      pickVoiceFromFeatures(
        features({
          isBrave: true,

...
/** Single JS-readable signed flag (no HttpOnly — SignPanel reads document.cookie). */
export function signedCookieHeader(requestUrl: string): string {
